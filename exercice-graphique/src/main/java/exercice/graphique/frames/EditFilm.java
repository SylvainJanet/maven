...
public class EditFilm extends JDialog {

	private static final long serialVersionUID = 4771339586643479539L;
	...
	public static void main(String[] args) {
		try {
			EditFilm dialog = new EditFilm(null, new Film());
	 ...
	 * Create the dialog.
	 */
	public EditFilm(Frame f, Film filmToEdit) {
		super(f);
		setTitle("Modification d'un film");
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						((App) EditFilm.this.getOwner()).refreshFilmList();
						EditFilm.this.dispose();
					}
				});
